			...
			<div className="absolute inset-0 backdrop-blur-md bg-black/5">
				<div className="flex flex-col items-center justify-center h-screen w-screen relative">
					<AppGrid
						...
						className="mx-auto h-[calc(100vh-158px)] grid-cols-4 gap-x-10 overflow-y-auto scrollbar-hide sm:grid-cols-5 lg:grid-cols-6 xl:grid-cols-7 xl:gap-x-16"
						labelClassName="text-xs text-white sm:text-sm"
					/>
